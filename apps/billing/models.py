...
#     max_discount_amount = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, help_text="Maximum discount allowed (e.g., ₦2000 max off)")   # check 
...
# # ==========================================
# # Corporate accounts should be for rebates 
...
#     price_list = models.ForeignKey(PriceList, on_delete=models.SET_NULL, null=True, blank=True, help_text="Which price list was applied")

#     insurance_provider = models.ForeignKey(InsuranceProvider, on_delete=models.SET_NULL, null=True, blank=True, related_name="billing_records")

#     policy_number = models.CharField(max_length=100, blank=True)
#     pre_authorization_code = models.CharField(max_length=100, blank=True)

#     corporate_client = models.ForeignKey(CorporateClient, on_delete=models.SET_NULL, null=True, blank=True) # cg
