# patients/views/slot_management.py
...
def staff_required(view_func):
    """Decorator to ensure user is lab staff or higher."""
    def wrapper(request, *args, **kwargs):
        ...
        if not (request.user.is_lab_staff or request.user.is_receptionist):
...
def admin_required(view_func):
    ...
    def wrapper(request, *args, **kwargs):
        ...
        if not (request.user.is_vendor_admin or request.user.is_lab_manager):
...
def slot_template_list(request):
    ...
    return render(request, 'staff/appointments/template_list.html', context)
...
def slot_template_create(request):
    ...
    return render(request, 'staff/appointments/template_form.html', context)
...
def generate_slots(request):
    ...
    return render(request, 'staff/appointments/generate_slots.html', context)
...
def slot_calendar(request):
    ...
    return render(request, 'staff/appointments/slot_calendar.html', context)
...
def slot_list(request):
    ...
    return render(request, 'staff/appointments/slot_list.html', context)
...
def slot_edit(request, slot_id):
    ...
    return render(request, 'staff/appointments/slot_edit.html', context)
