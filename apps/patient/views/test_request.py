...
from apps.labs.models import VendorTest, TestRequest, Department, TestResult
...
def patient_view_results(request, request_id):
    ...
    context = {
        ...
        'disclaimer': "IMPORTANT: This summary is generated by AI for informational purposes. "
                      "It is not a diagnosis. Always consult your doctor before making medical decisions."
    }
