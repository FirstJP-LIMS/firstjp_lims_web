        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "department",
                    models.ForeignKey(
                        help_text="Standard department responsible for this test.",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="global_tests",
                        to="labs.department",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sample_id",
                    models.CharField(
                        help_text="Globally unique ID for barcoding.",
                        max_length=64,
                        unique=True,
                    ),
                ),
                (
                    "specimen_type",
                    models.CharField(
                        help_text="Specimen type e.g. Blood, Urine, Serum, etc.",
                        max_length=100,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.SlugField(
                        blank=True,
                        help_text="Name to be used on the url bar.",
                        max_length=150,
                        null=True,
                    ),
                ),
