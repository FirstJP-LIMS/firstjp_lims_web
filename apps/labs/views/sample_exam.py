...
#             f"Payment is required first. "
#             f"Outstanding balance: ₦{test_request.billing_info.get_balance_due():,.2f}"
#         )
#         return redirect('billing:billing_detail', pk=test_request.billing_info.pk)
...
from apps.labs.models import Sample
